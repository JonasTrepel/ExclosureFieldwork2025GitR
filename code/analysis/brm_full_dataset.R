...
prior <- set_prior("normal(0, 5)", class = "Intercept") #generic weakly informative prior 
...
ggsave(plot = p_comb, "builds/plots/preliminary/brm_estimates.png", dpi = 600, height = 6, width = 12)
