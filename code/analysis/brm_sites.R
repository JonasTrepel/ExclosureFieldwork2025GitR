...
fwrite(estimates, "builds/model_outputs/brm_estimates_sites_separately.csv")
...
ggsave(plot = p_plot, "builds/plots/preliminary/brm_estimates_setups_seperate.png", dpi = 600, height = 6, width = 12)
